...
ONNX_MODEL_PATH = "/home/noor/A/projects/Upstyle/upstyle_ai/models/fashionclip.simplified.onnx"
...
# Note: Keys are already in 'snake_case' (e.g., 'primary_color'), 
# so they match your required output format directly.
ATTRIBUTE_CANDIDATES = OrderedDict([
    ...
    ("gender", ["male fashion","female fashion","unisex fashion","kids fashion"]),
    ("primary_color", [
        "black","white","gray","navy","blue","sky blue","red","maroon","green",
        "olive","khaki","yellow","beige","brown","tan","pink","purple","lavender",
        "orange","teal","cream"
    ]),
    ("secondary_color", [
        "black","white","gray","navy","blue","red","green","yellow",
        "beige","brown","pink","purple","orange"
    ]),
